...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#08090D] text-white font-sans selection:bg-[var(--color-brand)] selection:text-black relative overflow-x-hidden">

      {/* --- Ambient Background & Warm Golden Tech Glows --- */}
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        {/* Subtle grid pattern */}
        <div className="absolute inset-0 bg-grid-pattern opacity-40"></div>
        
        {/* Luminous Warm Amber Glow Orbs on Deep Obsidian */}
        <div className="absolute top-[-10%] left-[-5%] w-[600px] md:w-[950px] h-[600px] md:h-[950px] bg-[var(--color-brand)]/[0.09] blur-[150px] rounded-full mix-blend-screen pointer-events-none"></div>
        <div className="absolute top-[35%] right-[-10%] w-[500px] md:w-[850px] h-[500px] md:h-[850px] bg-[var(--color-brand-amber)]/[0.07] blur-[160px] rounded-full mix-blend-screen pointer-events-none"></div>
        <div className="absolute bottom-[5%] left-[5%] w-[600px] h-[600px] bg-sky-500/[0.03] blur-[170px] rounded-full mix-blend-screen pointer-events-none"></div>
      </div>
      ...
      <header className={`fixed top-0 w-full z-50 transition-all duration-300 ${
        ...
        <div className="max-w-7xl mx-auto px-5 md:px-10 flex justify-between items-center">
          ...
          <a href="#" className="flex items-center gap-3.5 group relative z-10">
            <div className="relative w-10 h-10 rounded-xl overflow-hidden bg-white/5 border border-white/10 p-1 flex items-center justify-center transition-all duration-300 group-hover:scale-105 group-hover:border-[var(--color-brand)]/60 shadow-[0_0_20px_rgba(255,149,0,0.25)]">
              <img 
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[10px] tracking-wider uppercase text-white/45 font-mono -mt-0.5">
                Rheinland Web3
              </span>
            </div>
          </a>
          ...
          <nav className="hidden lg:flex items-center gap-8">
            {navLinks.map((link) => (
              <a 
                key={link.name} 
                href={link.href} 
                className="text-sm font-medium text-white/75 hover:text-white transition-colors relative py-1 after:absolute after:bottom-0 after:left-0 after:w-0 after:h-[2px] after:bg-[var(--color-brand)] hover:after:w-full after:transition-all after:duration-200"
              >
                {link.name}
              </a>
            ))}
          ...
          <div className="hidden sm:flex items-center gap-3">
            ...
            <button
              ...
              className="relative overflow-hidden flex items-center gap-2 px-3.5 py-2 rounded-xl bg-white/[0.05] hover:bg-white/[0.1] border border-white/10 text-white text-xs font-semibold transition-all duration-200 active:scale-95 group shadow-sm"
            >
              <Beer size={16} className="text-[var(--color-brand)] group-hover:rotate-12 transition-transform" />
              <span>Prost!</span>
              <span className="bg-[var(--color-brand)]/20 text-[var(--color-brand)] px-1.5 py-0.5 rounded font-mono text-[11px] font-bold">
                {cheersCount}
              </span>
              {showCheerAnim && (
            ...
            <a 
              ...
              className="relative group overflow-hidden bg-[var(--color-brand)] hover:bg-[var(--color-brand-light)] text-black px-4.5 py-2.5 rounded-xl text-xs md:text-sm font-bold transition-all duration-300 flex items-center gap-2 shadow-[0_0_25px_rgba(255,149,0,0.35)] hover:shadow-[0_0_35px_rgba(255,149,0,0.55)] hover:-translate-y-0.5"
            >
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            className="fixed inset-0 z-40 bg-[#08090D]/98 backdrop-blur-2xl px-6 pt-28 pb-8 flex flex-col justify-between lg:hidden border-b border-white/10"
          >
            ...
            <div className="space-y-3 pt-6 border-t border-white/10">
              ...
              <a
                ...
                rel="noopener noreferrer"
                onClick={() => setIsMobileMenuOpen(false)}
                className="w-full bg-[var(--color-brand)] text-black font-bold text-center flex items-center justify-center gap-2.5 py-3.5 rounded-xl text-base shadow-lg shadow-[var(--color-brand)]/25"
              >
      ...
      <main className="relative z-10">
        ...
        <section className="relative min-h-[92vh] flex flex-col justify-center items-center pt-32 pb-20 px-5 md:px-8 overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto text-center relative z-10">
            ...
            <FadeIn delay={0.35} className="mb-14 max-w-4xl mx-auto">
              <div className="relative rounded-3xl overflow-hidden p-2 md:p-3 glass-card border border-[var(--color-brand)]/30 shadow-2xl shadow-black/80 group">
                <div className="relative rounded-2xl overflow-hidden aspect-[16/9] md:aspect-[21/9] bg-black/50">
                  <img 
                    src="/hero-bg.jpg" 
                  ...
                  <div className="absolute top-4 left-4 right-4 flex items-center justify-between">
                    <span className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-black/70 backdrop-blur-md border border-white/20 text-white text-xs font-semibold font-mono">
                      <span className="w-2 h-2 rounded-full bg-[var(--color-brand)] animate-pulse"></span>
                      Echte Community • Echter Dialog
                    </span>
                    <span className="hidden sm:inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-[var(--color-brand)] text-black text-xs font-bold font-mono shadow-md">
                      🍻 Kölsch & Web3
                    </span>
                  </div>
        ...
        {/* ========================================================================= */}
        <section className="py-14 border-y border-white/[0.08] bg-[#0D0E14]/70 relative overflow-hidden">
          {/* Gradient Edge Masks for soft fade */}
          <div className="absolute inset-y-0 left-0 w-24 md:w-48 bg-gradient-to-r from-[#08090D] to-transparent z-10 pointer-events-none"></div>
          <div className="absolute inset-y-0 right-0 w-24 md:w-48 bg-gradient-to-l from-[#08090D] to-transparent z-10 pointer-events-none"></div>

          <div className="max-w-7xl mx-auto px-6 mb-8 text-center">
            <span className="text-[11px] font-mono font-semibold tracking-[0.25em] text-white/45 uppercase">
          ...
          <div className="flex w-[200%] animate-marquee select-none items-center">
            ...
            <div className="flex w-1/2 justify-around items-center gap-12 px-6 opacity-75 hover:opacity-100 transition-opacity duration-300">
              <img src="/partners/solana-superteam.png" alt="Solana Superteam" className="h-9 md:h-11 object-contain brightness-150 contrast-125 hover:grayscale-0 hover:scale-105 transition-all duration-300" />
              <img src="/partners/base.png" alt="Base" className="h-8 md:h-10 object-contain brightness-150 hover:scale-105 transition-all duration-300" />
              <img src="/partners/startplatz.png" alt="Startplatz Köln" className="h-9 md:h-11 object-contain brightness-150 hover:scale-105 transition-all duration-300" />
              <img src="/partners/blockchain-reallabor.png" alt="Blockchain Reallabor" className="h-9 md:h-11 object-contain brightness-150 hover:scale-105 transition-all duration-300" />
              <img src="/partners/aachen-blockchain.png" alt="Aachen Blockchain" className="h-11 md:h-14 object-contain brightness-150 hover:scale-105 transition-all duration-300" />
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
              ...
              <FadeIn delay={0.2} className="lg:col-span-5">
                <div className="relative rounded-3xl overflow-hidden border border-white/15 bg-gradient-to-b from-white/10 to-white/[0.02] p-2.5 shadow-2xl group">
                  <div className="relative rounded-2xl overflow-hidden aspect-[4/3] bg-[#0E1017]">
                    <img 
                      src="/meetup.jpg" 
                    ...
                    <div className="absolute bottom-4 left-4 right-4 glass-panel p-4 rounded-xl border border-white/10 flex items-center justify-between shadow-lg">
                      <div>
                        <div className="text-xs font-bold text-white">Monatliche Meetups</div>
        ...
        {/* ========================================================================= */}
        <section id="values" className="py-28 md:py-36 px-5 md:px-10 bg-[#0E1017]/50 border-t border-white/[0.08] relative">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <FadeIn delay={0.1} className="md:col-span-2 glass-card glass-card-hover p-8 md:p-10 rounded-3xl relative overflow-hidden flex flex-col justify-between group">
                <div className="absolute top-0 right-0 w-80 h-80 bg-[var(--color-brand)]/[0.07] rounded-full blur-3xl -z-10 pointer-events-none"></div>
                
                <div>
                  <div className="w-14 h-14 rounded-2xl bg-[var(--color-brand)]/15 border border-[var(--color-brand)]/30 flex items-center justify-center text-2xl mb-6 text-[var(--color-brand)] group-hover:scale-110 transition-transform shadow-sm">
                    🍺
                  </div>
                ...
                <div className="mt-8 pt-6 border-t border-white/[0.08] flex items-center gap-4 text-xs font-mono text-[var(--color-brand)] font-semibold">
                  <span>#Offenheit</span>
              ...
              <FadeIn delay={0.2} className="glass-card glass-card-hover p-8 md:p-10 rounded-3xl relative overflow-hidden flex flex-col justify-between group">
                <div>
                  <div className="w-14 h-14 rounded-2xl bg-sky-500/15 border border-sky-500/30 flex items-center justify-center text-2xl mb-6 text-sky-400 group-hover:scale-110 transition-transform shadow-sm">
                    ⚡
                  </div>
                ...
                <div className="mt-8 pt-6 border-t border-white/[0.08] text-xs font-mono text-sky-400 font-semibold">
              ...
              <FadeIn delay={0.3} className="glass-card glass-card-hover p-8 md:p-10 rounded-3xl relative overflow-hidden flex flex-col justify-between group">
                <div>
                  <div className="w-14 h-14 rounded-2xl bg-amber-500/15 border border-amber-500/30 flex items-center justify-center text-2xl mb-6 text-amber-400 group-hover:scale-110 transition-transform shadow-sm">
                    📍
                  </div>
                  <h3 className="text-2xl font-serif font-bold text-white mb-3">
                    Mitten in Kölle
                ...
                <div className="mt-8 pt-6 border-t border-white/[0.08] text-xs font-mono text-amber-400 font-semibold">
              ...
              <FadeIn delay={0.4} className="md:col-span-2 glass-card glass-card-hover p-8 md:p-10 rounded-3xl relative overflow-hidden flex flex-col justify-between group">
                ...
                <div>
                  <div className="w-14 h-14 rounded-2xl bg-emerald-500/15 border border-emerald-500/30 flex items-center justify-center text-2xl mb-6 text-emerald-400 group-hover:scale-110 transition-transform shadow-sm">
                    🛡️
                  </div>
                  <h3 className="text-2xl md:text-3xl font-serif font-bold text-white mb-3">
                ...
                <div className="mt-8 pt-6 border-t border-white/[0.08] flex items-center gap-4 text-xs font-mono text-emerald-400 font-semibold">
            ...
            <FadeIn delay={0.2} className="relative rounded-3xl overflow-hidden glass-card border border-white/15 shadow-2xl p-2 md:p-5">
              ...
              <div className="flex items-center justify-between pb-3 px-3 pt-1 border-b border-white/[0.06] mb-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-mono text-white/45 ml-2">kryptokoelsch.lu.ma/events</span>
                </div>
                <div className="text-xs text-white/45 font-mono hidden sm:block">
                  Live Event Calendar
                </div>
              </div>
        ...
        {/* ========================================================================= */}
        <section id="team" className="py-28 md:py-36 px-5 md:px-10 bg-[#0E1017]/50 border-t border-white/[0.08] relative">
          <div className="max-w-7xl mx-auto">
              ...
              <FadeIn delay={0.1} className="glass-card glass-card-hover p-8 rounded-3xl relative overflow-hidden group">
                ...
                <div className="flex items-center gap-5 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-white/45 font-mono">aka m0ebius</p>
              ...
              <FadeIn delay={0.2} className="glass-card glass-card-hover p-8 rounded-3xl relative overflow-hidden group">
                ...
                <div className="flex items-center gap-5 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-white/45 font-mono">aka 0xBoxer</p>
                    <p className="text-sm font-semibold text-[var(--color-brand)] mt-1">
              ...
              {faqs.map((faq, index) => {
                ...
                return (
                  <FadeIn key={index} delay={index * 0.05}>
                    <div className="glass-card rounded-2xl border border-white/[0.08] overflow-hidden transition-colors shadow-sm">
                      <button
                      ...
                      <AnimatePresence>
                        {isOpen && (
                          <motion.div
                            ...
                            transition={{ duration: 0.25 }}
                          >
                            <div className="px-6 pb-6 text-white/70 leading-relaxed font-light text-base border-t border-white/[0.04] pt-4">
                              {faq.a}
                            </div>
                          </motion.div>
                        )}
        ...
        {/* ========================================================================= */}
        <section id="community" className="py-28 md:py-36 px-5 md:px-10 relative overflow-hidden bg-[#07080B] border-t border-white/[0.08]">
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            <FadeIn className="glass-card p-10 md:p-16 rounded-[2.5rem] border border-[var(--color-brand)]/35 relative overflow-hidden shadow-2xl">
      ...
      {/* 9. FOOTER & LEGAL                                                        */}
      {/* ========================================================================= */}
      <footer className="border-t border-white/[0.08] bg-[#050608] pt-20 pb-12 px-5 md:px-10 relative z-10">
        <div className="max-w-7xl mx-auto flex flex-col items-center text-center">
          
          {/* Logo */}
          <a href="#" className="flex items-center gap-3 mb-6 group">
            <div className="w-11 h-11 rounded-xl overflow-hidden border border-white/15 p-1 bg-white/5 shadow-sm">
              <img 
                src="/kryptokoelsch_logo.png" 
                onError={(e) => { (e.target as HTMLElement).setAttribute('src', '/kryptokoelsch_logo_new.jpg'); }} 
                alt="Logo" 
        ...
        {showImpressum && (
          ...
          >
            <motion.div
              ...
              className="bg-[#10121A] border border-white/15 rounded-3xl max-w-3xl w-full max-h-[85vh] overflow-y-auto p-7 md:p-10 relative shadow-2xl custom-scrollbar"
              onClick={(e) => e.stopPropagation()}
            >
              <button 
                onClick={() => setShowImpressum(false)} 
                className="absolute top-6 right-6 w-9 h-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white hover:text-[var(--color-brand)] transition-colors"
